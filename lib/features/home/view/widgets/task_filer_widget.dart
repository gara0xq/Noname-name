...
class TaskFilterWidget extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> _filters = const [
    {'value': null, 'label': 'All Tasks', 'icon': Icons.all_inclusive, 'color': AppColors.darkPrimary},
    {'value': 'pending', 'label': 'Pending', 'icon': Icons.pending_actions, 'color': AppColors.primaryOrange},
    {'value': 'submitted', 'label': 'Submitted', 'icon': Icons.upload_file, 'color': AppColors.primaryGreen},
    {'value': 'completed', 'label': 'Completed', 'icon': Icons.check_circle, 'color': Color(0xFF2E7D32)},
    {'value': 'expired_Declined', 'label': 'Expired/Declined', 'icon': Icons.error_outline, 'color': Colors.red},
  ];
